...
async def on_message(message):
    ...
    if message.content.lower() in ['siema', 'elo', 'witam', 'uszanowanko', 'czesc']:
        powitajki = [
            'Uszanowanko',
            'Gitara siema',
            'Fortepian elo',
        ...
        odp = [
            ...
            'Jebany rasista',
            'Czarnuch z ciebie',
            'Młody chcesz cukierka?',
            'Wbić to ja Ci mogę ale kose w żebro',
            'A wyjebać ci tak Profilaktycznie ??',
            'To masz szczęscie',
            'Ja pale tylko bez filtra',
            ...
            'Ty byś tylko pierdolony skurwysynie',
